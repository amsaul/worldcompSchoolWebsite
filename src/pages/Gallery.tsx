...
const Gallery = () => {
  ...
  const images = [
    {
      id: 1,
      url: 'https://i.postimg.cc/3xKmrfPQ/library-2.jpg',
      category: 'Campus',
      title: 'School Building',
    },
    {
      id: 2,
      url: 'https://i.postimg.cc/rps4x0yy/kids-in-clas.jpg',
      category: 'Classrooms',
      title: 'Modern Classroom',
    },
    {
      id: 3,
      url: 'https://i.postimg.cc/x1tHXy2p/kids-studying.jpg',
      category: 'Events',
      title: 'Science Fair',
    },
    // {
    ...
    {
      id: 5,
      url: 'https://i.postimg.cc/0N4wfkrQ/groupkids.jpg',
      category: 'Activities',
      title: 'Art Class',
    },
    {
      id: 6,
      url: 'https://i.postimg.cc/FKzS3dFN/kids-in-class2.jpg',
      category: 'Classrooms',
      title: 'Computer Lab',
    },
    {
      id: 7,
      url: 'https://i.postimg.cc/mrnHwLhr/outside-school.jpg',
      category: 'Campus',
    ...
    {
      id: 9,
      url: 'https://i.postimg.cc/wj6Lx4SJ/kids-outside-2.jpg',
      category: 'Sports',
      title: 'soccer practice',
    },
    {
      id: 10,
      url: 'https://i.postimg.cc/bw3bZHh3/football.jpg',
      category: 'Sports',
      title: 'Soccer Practice',
    },
    {
    ...
    {
      id: 12,
      url: 'https://i.postimg.cc/jj2fPwxp/kids-with-mzungu-2.jpg',
      category: 'Events',
      title: 'Annual Day',
    },
  ];
